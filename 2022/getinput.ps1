...
Invoke-WebRequest -UseBasicParsing -Uri "https://adventofcode.com/2022/day/$($param1)/input" `
-WebSession $session `
...
"method"="GET"
  ...
  "referer"="https://adventofcode.com/2022/day/$($param1)"
