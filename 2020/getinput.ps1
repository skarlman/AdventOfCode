...
Invoke-WebRequest -UseBasicParsing -Uri "https://adventofcode.com/2020/day/$($param1)/input" `
-WebSession $session `
-OutFile ".\day$($param1)\input.txt" `
-Headers @{
"authority"="adventofcode.com"
  "method"="GET"
  "path"="/2020/day/$($param1)/input"
  "scheme"="https"
  ...
  "pragma"="no-cache"
  "referer"="https://adventofcode.com/2020/day/$($param1)"
