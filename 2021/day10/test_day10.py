...
class AocTest(unittest.TestCase):
    def test_part_a_real(self):
        self.assertEqual(369105, solve(1, False), "Part 1 REAL")

    def test_part_a_example(self):
        self.assertEqual(26397, solve(1, True), "Part 1 example")

    def test_part_b_real(self):
        self.assertEqual(3999363569, solve(2, False), "Part 2 REAL")

    def test_part_b_example(self):
        self.assertEqual(288957, solve(2, True), "Part 2 example")
